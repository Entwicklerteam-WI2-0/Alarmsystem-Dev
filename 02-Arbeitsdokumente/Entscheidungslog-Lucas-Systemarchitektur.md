...
- *Bezug:* DTB-63; NF-07/NF-09; **DTB-54**/E-39 (append-only); RB-01/E-15; NF-01/E-40; schließt EP-06-Offenpunkt; `src/api/security.py`, `src/api/v1.py` (`PUT /v1/thresholds`), `src/storage/threshold_set_repository.py`, `src/main.py` (`_load_active_thresholds`), `docs/api/v1/openapi.yaml`; **löst PR #116 ab**.
