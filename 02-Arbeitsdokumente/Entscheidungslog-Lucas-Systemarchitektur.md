...
- *Bezug:* **NF-01** (Pflicht); **E-34** (Assessment-Schicht/Kaskade); **E-35** (DB-Ausfall-Schicht, rohes PyMySQL); **E-31** (`/health` getrennt von Datenaktualität); **E-36** (eingefrorener G2→G3-Contract: `unknown`+`is_stale=true` als Fail-safe-Signal / API-Format-Herkunft); DTB-13 (Stale/Plausibilität), DTB-43 (503-Pfad), DTB-64 (Assess-/Serve-Zeit-Verdrahtung); blockt DTB-20 (P3.2). Querverweis persönliches Log: DTB-64-Eintrag (2026-06-26).
