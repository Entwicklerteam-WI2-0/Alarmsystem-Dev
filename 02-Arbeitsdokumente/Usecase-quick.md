...
| **FA-13** | _(NEU)_ Jede **Wetterstation hat eine hinterlegte Geoposition** (GPS-Koordinaten lat/lon, optional als Geohash kodiert); das **Frontend zeigt den Stationsstandort** an. | Kann | Annahme | Team-Sync mit G3 (18.06.2026); UI-Enabler für Multi-Standort-Betrieb (NF-11). _Offen:_ Position als Stations-Stammdatum (ortsfest) vs. pro Reading; Liefer-/Anzeigeweg (Text vs. Karte) im Team-Sync zu klären. |
